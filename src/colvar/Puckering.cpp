...
//    Vector Rpp = Vector(0.0, 0.0, 0.0);
    ...
    vrho->set(rho);
    setAtomsDerivatives (vrho,0, drho_dR[0] );
    setAtomsDerivatives (vrho,1, drho_dR[1] );
    setAtomsDerivatives (vrho,2, drho_dR[2] );
    setAtomsDerivatives (vrho,3, drho_dR[3] );
    setAtomsDerivatives (vrho,4, drho_dR[4] );
    setAtomsDerivatives (vrho,5, drho_dR[5] );
    setAtomsDerivatives (vrho,6, drho_dR[6] );
    setBoxDerivativesNoPbc(vrho);
    
    // ANGULAR ROTATION or BOATNESS MEASURE by Theta
    double theta7m = std::atan2(q3, q2);
    
    // Theta DERIVATIVES
    std::vector<Vector> dtheta7m_dR(7);
    for(unsigned j=0; j<7; j++) {
        dtheta7m_dR[j]= (1.0/(std::sqrt(A2*A2 + B2*B2) * std::sqrt(A3*A3 + B3*B3) * (A2*A2 + B2*B2 + A3*A3 + B3*B3))) * (A3 *dA3_dR[j] * (A2*A2 + B2*B2) - A2 *dA2_dR[j] * (A3*A3 + B3*B3) + B3 *dB3_dR[j] * (A2*A2 + B2*B2) - B2 *dB2_dR[j] * (A3*A3 + B3*B3));
    }
    
    Value* vtheta7m=getPntrToComponent("theta7m");
    vtheta7m->set(theta7m);
    setAtomsDerivatives (vtheta7m,0, dtheta7m_dR[0] );
    setAtomsDerivatives (vtheta7m,1, dtheta7m_dR[1] );
    setAtomsDerivatives (vtheta7m,2, dtheta7m_dR[2] );
    setAtomsDerivatives (vtheta7m,3, dtheta7m_dR[3] );
    setAtomsDerivatives (vtheta7m,4, dtheta7m_dR[4] );
    setAtomsDerivatives (vtheta7m,5, dtheta7m_dR[5] );
    setAtomsDerivatives (vtheta7m,6, dtheta7m_dR[6] );
    ...
    Value* vtau2=getPntrToComponent("tau2");
    vtau2->set(tau2);
    setAtomsDerivatives (vtau2,0, dtau2_dR[0] );
    setAtomsDerivatives (vtau2,1, dtau2_dR[1] );
    setAtomsDerivatives (vtau2,2, dtau2_dR[2] );
    setAtomsDerivatives (vtau2,3, dtau2_dR[3] );
    setAtomsDerivatives (vtau2,4, dtau2_dR[4] );
    setAtomsDerivatives (vtau2,5, dtau2_dR[5] );
    setAtomsDerivatives (vtau2,6, dtau2_dR[6] );
    ...
    Value* vtau3=getPntrToComponent("tau3");
    vtau3->set(tau3);
    setAtomsDerivatives (vtau3,0, dtau3_dR[0] );
    setAtomsDerivatives (vtau3,1, dtau3_dR[1] );
    setAtomsDerivatives (vtau3,2, dtau3_dR[2] );
    setAtomsDerivatives (vtau3,3, dtau3_dR[3] );
    setAtomsDerivatives (vtau3,4, dtau3_dR[4] );
    setAtomsDerivatives (vtau3,5, dtau3_dR[5] );
    setAtomsDerivatives (vtau3,6, dtau3_dR[6] );
    ...
    // x,y,z,w DERIVATIVES
    std::vector<Vector> dx7m_dR(7);
    for(unsigned j=0; j<7; j++) {
        dx7m_dR[j]= dA2_dR[j] * std::sqrt(2.0/7.0);
    }
    
    Value* vx7m=getPntrToComponent("x7m");
    vx7m->set(x7m);
    setAtomsDerivatives (vx7m,0, dx7m_dR[0] );
    setAtomsDerivatives (vx7m,1, dx7m_dR[1] );
    setAtomsDerivatives (vx7m,2, dx7m_dR[2] );
    setAtomsDerivatives (vx7m,3, dx7m_dR[3] );
    setAtomsDerivatives (vx7m,4, dx7m_dR[4] );
    setAtomsDerivatives (vx7m,5, dx7m_dR[5] );
    setAtomsDerivatives (vx7m,6, dx7m_dR[6] );
    setBoxDerivativesNoPbc(vx7m);
    
    std::vector<Vector> dy7m_dR(7);
    for(unsigned j=0; j<7; j++) {
        dy7m_dR[j]= -dB2_dR[j] * std::sqrt(2.0/7.0);
    }
    
    Value* vy7m=getPntrToComponent("y7m");
    vy7m->set(y7m);
    setAtomsDerivatives (vy7m,0, dy7m_dR[0] );
    setAtomsDerivatives (vy7m,1, dy7m_dR[1] );
    setAtomsDerivatives (vy7m,2, dy7m_dR[2] );
    setAtomsDerivatives (vy7m,3, dy7m_dR[3] );
    setAtomsDerivatives (vy7m,4, dy7m_dR[4] );
    setAtomsDerivatives (vy7m,5, dy7m_dR[5] );
    setAtomsDerivatives (vy7m,6, dy7m_dR[6] );
    setBoxDerivativesNoPbc(vy7m);
    
    
    std::vector<Vector> dz7m_dR(7);
    for(unsigned j=0; j<7; j++) {
        dz7m_dR[j]= -dB3_dR[j] * std::sqrt(2.0/7.0);
    }
    
    Value* vz7m=getPntrToComponent("z7m");
    vz7m->set(z7m);
    setAtomsDerivatives (vz7m,0, dz7m_dR[0] );
    setAtomsDerivatives (vz7m,1, dz7m_dR[1] );
    setAtomsDerivatives (vz7m,2, dz7m_dR[2] );
    setAtomsDerivatives (vz7m,3, dz7m_dR[3] );
    setAtomsDerivatives (vz7m,4, dz7m_dR[4] );
    setAtomsDerivatives (vz7m,5, dz7m_dR[5] );
    setAtomsDerivatives (vz7m,6, dz7m_dR[6] );
    setBoxDerivativesNoPbc(vz7m);
    
    std::vector<Vector> dw7m_dR(7);
    for(unsigned j=0; j<7; j++) {
        dw7m_dR[j]= dA3_dR[j] * std::sqrt(2.0/7.0);
    }
    
    Value* vw7m=getPntrToComponent("w7m");
    vw7m->set(w7m);
    setAtomsDerivatives (vw7m,0, dw7m_dR[0] );
    setAtomsDerivatives (vw7m,1, dw7m_dR[1] );
    setAtomsDerivatives (vw7m,2, dw7m_dR[2] );
    setAtomsDerivatives (vw7m,3, dw7m_dR[3] );
    setAtomsDerivatives (vw7m,4, dw7m_dR[4] );
    setAtomsDerivatives (vw7m,5, dw7m_dR[5] );
    setAtomsDerivatives (vw7m,6, dw7m_dR[6] );
    setBoxDerivativesNoPbc(vw7m);
    }
}
}
